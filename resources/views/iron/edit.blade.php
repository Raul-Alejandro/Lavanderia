...
<h2>Editar Servicio - {{$service->name}} - Planchado</h2>
<div>
	{!!Form::model($service,['route'=>['iron-service.update',$service->id],'method'=>'PATCH','id'=>'service-form'])!!}
		...
		<div class="col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3 col-sm-12 col-xs-12" id="tel">
			<div class="form-group">
				{!!Form::label('promotion_cost','Costo de Promocion',['class'=>'control-label'])!!}
				{!!Form::number('promotion_cost',null,['class'=>'form-control','placeholder'=>'Costo de Promocion del Servicio','min'=>0])!!}
			</div>
		</div>
		<div class="col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3 col-sm-12 col-xs-12">
			<div class="form-group">
				{!!Form::submit('Enviar',['class'=>'btn btn-primary'])!!}
				<a href="{{url('iron-service')}}" class="btn btn-danger">Cancelar</a>
			</div>
		</div>
	{!!Form::close()!!}
</div>
